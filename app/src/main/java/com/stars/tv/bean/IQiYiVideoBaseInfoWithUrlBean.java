...
public class IQiYiVideoBaseInfoWithUrlBean extends IQiYiBaseBean{
    ...
    public String toString() {
        return "IQiYiVideoBaseInfoWithUrlBean{" +
                "albumId=" + albumId +
                ", albumName='" + albumName + '\'' +
                ", albumUrl='" + albumUrl + '\'' +
                ", imageUrl='" + imageUrl + '\'' +
    ...
    public String getIsfeizhengpian() {
        return isfeizhengpian;
    }

    public void setIsfeizhengpian(String isfeizhengpian) {
        this.isfeizhengpian = isfeizhengpian;
    }
