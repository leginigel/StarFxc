...
import com.stars.tv.sample.CartoonBannerItemPresenter;
import com.stars.tv.sample.SeriesAndRecButtonItemPresenter;
import com.stars.tv.sample.CartoonButtonListRow;
import com.stars.tv.sample.HotVideoListRow;
import com.stars.tv.sample.SeriesAndRecVideoDataList;
import com.stars.tv.sample.CartoonVideoItemPresenter;
...
public class CartoonVideoRowSampleFragment extends BaseFragment {
    private static final String TAG = "CartoonVideoRow";
    ...
    private String[] orderlist = {"32796,32797,32799", "38,30220", "37,30220", "30218,30220", "30220,32784", "30230,30220", "30232,30267,30220", "30243,30249,30220", "30268,30220", "30245,30247", "30224", "30252,30270", "32798,30220,30268", "37，30254","37,32785"};
    private int totalRow = 17;

    public CartoonVideoRowSampleFragment() {
    }

    public static CartoonVideoRowSampleFragment getInstance(String titleMode) {
        return newInstance(titleMode);
    }

    public static CartoonVideoRowSampleFragment newInstance(String titleName){
        CartoonVideoRowSampleFragment myFragment = new CartoonVideoRowSampleFragment();
    ...
    private void showBannerData(){
        mRowsAdapter.clear();
        CartoonBannerItemPresenter cartoonBannerItemPresenter = new CartoonBannerItemPresenter();
        ArrayObjectAdapter listRowAdapter = new ArrayObjectAdapter(cartoonBannerItemPresenter);
        ...
        mRowsAdapter.add(new CartoonButtonListRow(gridRowAdapter));
    }

    private void showVideoData(){
        CartoonVideoItemPresenter videoItemPresenter0 = new CartoonVideoItemPresenter();
        ...
        HeaderItem header0 = new HeaderItem(category, SeriesAndRecVideoDataList.CARTOON_CATEGORY[category]);
            ...
            public void onLoadMore() {
                ...
                if (mPageNum <= totalPage) {
                    for(int i=0;i<loadRows; i++) {
                        parseIQiYiMovieSimplifiedList((mPageNum - 1) * loadRows + i, 4, orderlist[(mPageNum - 1) * loadRows + i], "", "",
                                24, 1, 1, "iqiyi", 1, "", 12);
                    }
    ...
    private void parseIQiYiMovie(){
        parseIQiYiMovieSimplifiedList(0, 4, orderlist[0], "", "", 4, 1, 1, "iqiyi", 1, "", 12);
        parseIQiYiMovieSimplifiedList(1, 4, orderlist[1], "", "", 11, 1, 1, "iqiyi", 1, "", 12);
        parseIQiYiMovieSimplifiedList(2, 4, orderlist[2], "", "", 24, 1, 1, "iqiyi", 1, "", 12);
    }
...
//        vh.itemView.setBackground(new ColorDrawable(selected ? getResources().getColor(R.color.color_focus) : getResources().getColor(R.color.color_transparent)));
    ...
    protected void loadData() {
        ...
        parseIQiYiParseBannerInfo("dongman");
    }
