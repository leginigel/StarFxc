...
import com.stars.tv.sample.VarietyBannerItemPresenter;
import com.stars.tv.sample.SeriesAndRecButtonItemPresenter;
import com.stars.tv.sample.VarietyButtonListRow;
import com.stars.tv.sample.HotVideoListRow;
import com.stars.tv.sample.SeriesAndRecVideoDataList;
import com.stars.tv.sample.VarietyVideoItemPresenter;
...
public class VarietyVideoRowSampleFragment extends BaseFragment {
    private static final String TAG = "VarietyVideoRowSampleFragment";
    ...
    private String[] orderlist = {"151", "2224","163,2120","2121","157","2118","1003","2119","156","2224,30274","30279","30276,2224","2121,159","30277","293"};
    private int totalRow = 17;

    public VarietyVideoRowSampleFragment() {
    }

    public static VarietyVideoRowSampleFragment getInstance(String titleMode) {
        return newInstance(titleMode);
    }

    public static VarietyVideoRowSampleFragment newInstance(String titleName){
        VarietyVideoRowSampleFragment myFragment = new VarietyVideoRowSampleFragment();
    ...
    private void showBannerData(){
        mRowsAdapter.clear();
        VarietyBannerItemPresenter varietyBannerItemPresenter = new VarietyBannerItemPresenter();
        ArrayObjectAdapter listRowAdapter = new ArrayObjectAdapter(varietyBannerItemPresenter);
        ...
        mRowsAdapter.add(new VarietyButtonListRow(gridRowAdapter));
    }

    private void showVideoData(){
        VarietyVideoItemPresenter videoItemPresenter0 = new VarietyVideoItemPresenter();
        ...
        HeaderItem header0 = new HeaderItem(category, SeriesAndRecVideoDataList.VARIETY_CATEGORY[category]);
    ...
    private void parseIQiYiMovie(){
        parseIQiYiMovieSimplifiedList(0, 6, orderlist[0], "", "", 4, 1, 1, "iqiyi", 1, "", 12);
        parseIQiYiMovieSimplifiedList(1, 6, orderlist[1], "", "", 11, 1, 1, "iqiyi", 1, "", 12);
        parseIQiYiMovieSimplifiedList(2, 6, orderlist[2], "", "", 24, 1, 1, "iqiyi", 1, "", 12);
    }
...
//        vh.itemView.setBackground(new ColorDrawable(selected ? getResources().getColor(R.color.color_focus) : getResources().getColor(R.color.color_transparent)));
    ...
    protected void loadData() {
        ...
        parseIQiYiParseBannerInfo("zongyi");
    }
