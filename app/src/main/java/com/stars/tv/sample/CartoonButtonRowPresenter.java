...
public class CartoonButtonRowPresenter extends RowPresenter {
    protected Context mContext;
    private static final String TAG = "CartoonButtonRowPresenter";
    ...
    public CartoonButtonRowPresenter() {
    ...
    protected ViewHolder createRowViewHolder(ViewGroup parent) {
        View root = LayoutInflater.from(parent.getContext()).inflate(R.layout.cartoon_item_button_row_layout, null, false);
