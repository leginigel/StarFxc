...
public class SeriesVideoItemPresenter extends Presenter {
...
//    private static final int CARD_HEIGHT = 200;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent) {
        View view = View.inflate(parent.getContext(), R.layout.item_series_video_layout, null);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, Object item) {
        ...
        episodeTv = viewHolder.view.findViewById(R.id.episode_tv);
        ...
        if(latestOrder!=null &&videoCount!=null)
        {
            if (Objects.requireNonNull(videoCount).equals(Objects.requireNonNull(latestOrder))) {
                ...
                episodeTv.setText(videoBean.getLatestOrder() + "集全");
            } else {
                episodeTv.setText("更新至" + videoBean.getLatestOrder() + "集");
            }
        }
